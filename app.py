...
#  Flask documentation: https://flask.palletsprojects.com/en/1.1.x/api/#flask.json.jsonify
...
def stats(start=None, end=None):
	...
	#  /api/v1.0/temp/start/end route -> [null,null,null]
	#  Add following to path to address in browser:
